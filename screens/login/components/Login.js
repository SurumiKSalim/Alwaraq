      ...
      <SafeAreaView style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scroll}>
          {!(
            ...
            (this.props.activeSession.includes('Profile') ||
              this.props.activeSession.includes('Maps') ||
              this.props.activeSession.includes('Trips') ||
              this.props.activeSession.includes('TripDetail') ||
              this.props.activeSession.includes('Profile'))
          ) && (
          ...
          <View style={styles.password}>
            ...
            <TouchableOpacity
              ...
              <FontAwesome5
                name={this.state.showpswrd ? 'eye-slash' : 'eye'}
                size={18}
                color="#656565"
              />
            </TouchableOpacity>
