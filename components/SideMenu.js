...
const EV_APP_LINKS =
  Platform.OS === 'ios'
    ? 'https://appstore.electronicvillage.org'
    : 'https://googlestore.electronicvillage.org';
const SOCIAL_LINKS = [
  {
    link: 'https://www.facebook.com/alwaraq.net',
    name: 'facebook-square',
    color: '#4267B2',
  },
  {
    link: 'https://www.instagram.com/alwaraq.books',
    name: 'instagram',
    color: '#cd486b',
  },
  {
    link: 'https://twitter.com/alwaraq',
    name: 'twitter-square',
    color: '#1da1f2',
  },
  {link: 'https://www.Alwaraq.net', name: 'globe', color: '#C53939'},
];
      ...
      <Fragment style={{}}>
        <View style={styles.container}>
          ...
          <ScrollView
            ...
            <TouchableOpacity
              onPress={this.navigateToScreen('Libraries')}
              style={styles.content}>
              <Feather
                name="book-open"
                style={styles.iconContainer}
            ...
            <TouchableOpacity
              onPress={() => this.navigateToPublisher()}
              style={styles.content}>
              <SimpleLineIcons
                name="pencil"
                style={styles.iconContainer}
            ...
            <TouchableOpacity
              onPress={this.navigateToScreen('AuthorList')}
              style={styles.content}>
              <SimpleLineIcons
                name="user"
                style={styles.iconContainer}
            ...
            <TouchableOpacity
              onPress={this.navigateToScreen('Quran')}
              style={styles.content}>
              <Feather
                name="book"
                style={styles.iconContainer}
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('BookList', {listType: 'free'})
              }
              style={styles.content}>
              <SimpleLineIcons
                name="book-open"
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('BookList', {isJapanese: true})
              }
              style={styles.content}>
              <SimpleLineIcons
                name="book-open"
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('BookList', {
                  authorId: 959,
                  authorName: I18n.t('Shakespeare_Books'),
                })
              }
              style={styles.content}>
              <SimpleLineIcons
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('BookList', {
                  listType: 'translated',
                  authorName: I18n.t('Translated_Books'),
                })
              }
              style={styles.content}>
              <SimpleLineIcons
            ...
            {this.props.user && (
              <TouchableOpacity
                onPress={this.navigateToScreen('Purchased')}
                style={styles.content}>
                <Feather
                  name="unlock"
                  style={styles.iconContainer}
            ...
            {this.props.user && (
              <TouchableOpacity
                onPress={this.navigateToScreen('Favourites')}
                style={styles.content}>
                <Feather
                  name="heart"
                  style={styles.iconContainer}
            ...
            <View style={styles.footerContainer}>
              <TouchableOpacity
                onPress={
                  this.props.user
                    ? this.navigateToScreen('ShareEarn')
              ...
              <TouchableOpacity
                ...
                <Text style={styles.footerTitle}>
                  {this.props.user ? I18n.t('Settings') : I18n.t('Login')}
                </Text>
              </TouchableOpacity>
              {this.props.user && (
                <TouchableOpacity
            ...
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('Applications')}
              style={styles.card}>
