...
import { Platform, KeyboardAvoidingView, Text, View, StyleSheet, TouchableOpacity, TextInput } from 'react-native'
...
class App extends Component {
        ...
        if (this.state.currentLanguage != this.props.locale) {
            ...
            this.setState({ selection: 0 })
            {
                this.props.user ?
                    ...
                    this.props.dispatch(resetFirstLogin({ locale: this.state.currentLanguage }))
            }
    ...
    getUsedTranslation = () => {
        return this.props.user ? this.props.user && this.props.user.language : this.props.locale
    ...
    renderModalPassword = () => (
        <View style={styles.content}>
            <View style={styles.modalClose}>
                <TouchableOpacity style={styles.iconContainer1} onPress={() => this.props.dispatch(toogleLanguageModal())}>
                    <Ionicons name='ios-close-circle-outline' size={30} color={WHITE_COLOR} />
                </TouchableOpacity>
            </View>
            <View>
